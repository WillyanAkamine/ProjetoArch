...
<section>
    <div class="flex row gap-3 w-50 bg-white shadow-lg rounded-lg overflow-hidden mx-auto p-4">

        <h2>Custo da Obra</h2>

        <form id="cost-form">
            <input type="text" value="<?= $client_id ?>" hidden name="user_id" id="user_id" value="<?= $client_id ?>" />
        ...
        <div class="flex gap-5 place-content-around">
          <div>
